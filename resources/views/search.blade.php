...
@section("content")
<img class="banner" src="{{asset("/img")}}/corporate_title_image.jpg" alt="" loading="lazy">
                            ...
                            @switch(app()->getLocale())
                                ...
                                <div class="post">
                                    <div class="post_image">
                                        <img src="{{asset($article->title_image)}}" alt="{{$article->title_en}}" loading="lazy">
                                    </div>
                                ...
                                <div class="post">
                                    <div class="post_image">
                                        <img src="{{asset($article->title_image)}}" alt="{{$article->title_ar}}" loading="lazy">
                                    </div>
                                    <div class="post_title">
                                ...
                                @case("ar")
                                    <div class="post">
                                        <div class="post_image">
                                            <img src="{{asset($article->title_image)}}" alt="{{$article->title_ru}}" loading="lazy">
                                        </div>
                                        <div class="post_title">
