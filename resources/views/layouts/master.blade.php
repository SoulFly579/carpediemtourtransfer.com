...
<div class="header-info">
        <div class="container">
            +90 542 231 24 46 - info@carpediemtourtransfer.com
        </div>
</div>
<header>
    <div class="container">
        <div class="row">
            <div class="col-md-3 logo" title="Carpediem!"><img src="{{asset("/img")}}/Carpe_Diem.png" alt="Logo"></div>
            ...
            <div class="list_nav">
                <div class="social_media">
                    <a href="https://www.facebook.com/carpediemtourtransfer" title="Facebook">
                    ...
                    <a href="https://twitter.com/carpe_diem_tour" title="Twitter">
                    ...
                    <a href="https://www.instagram.com/carpe_diem_tour_transfer/" title="Instagram">
                    ...
                    <a href="https://www.tiktok.com/@carpe_diem_tour_transfer?lang=tr-TR" title="Tiktok">
                        <img class="tiktok_icon" src="https://www.designbust.com/download/1840/png/tiktok_white_transparent512.png" alt="">
                    </a>
                    <a href="https://www.youtube.com/channel/UCDmXuKG1v3dvmEYSgCUhHBw" title="YouTube">
...
<div class="wp_phone_buttons">
    <a target="_blank" href="https://api.whatsapp.com/send?phone=905422312446&text=Merhaba,%20size%20web%20sitenizden%20ula%C5%9F%C4%B1yorum.">
...
<footer>
    ...
    <p class="container"><a href="{{url(app()->getLocale()."/terms")}}">{{__("footer.cookies_and_privacy")}}</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="{{url(app()->getLocale()."/terms")}}">{{__("footer.terms_of_use")}}</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="{{url(app()->getLocale()."/terms")}}">{{__("footer.kvkk")}}</a>&nbsp;&nbsp;|&nbsp;&nbsp;Copyright © 2020 -
