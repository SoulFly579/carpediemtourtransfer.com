...
@section('content')
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                            Website Status</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{$settings->maintenance == 1 ? "Open":"Close" }}</div>
                                    </div>
                                    <div class="col-auto">
                ...
                <div class="row">
                    ...
                    <div class="mb-4 w-100" style="display: inline-flex; justify-content: space-around; align-items: center;">
                        ...
                        <!-- Illustrations -->
                        @if($articles_count !== 0)
                        <div class="card shadow mb-4" style="@if($services_count !== 0)width: 40%; @else width: 100%; @endif min-height: 100%; ">
                        ...
                        @endif
                        @if($services_count !== 0)
                        <div class="card shadow mb-4" style="@if($articles_count !== 0)width: 40%; @else width: 100%; @endif min-height: 100%;">
                            <div class="card-header py-3">
                                <h5>Last Service</h5>
