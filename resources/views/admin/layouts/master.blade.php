...
<head>
    ...
    <link rel="stylesheet" href="{{asset('administrator/')}}/vendor/datatables/dataTables.bootstrap4.min.css"
          rel="stylesheet">
</head>
<body id="page-top" style="position: relative;">
    ...
    <!-- Page level plugins -->
    <script src="{{asset('administrator/')}}/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="{{asset('administrator/')}}/vendor/datatables/dataTables.bootstrap4.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="{{asset('administrator/')}}/js/demo/datatables-demo.js"></script>
    @yield("js")
</body>
