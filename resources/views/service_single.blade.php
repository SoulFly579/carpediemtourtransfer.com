...
@section("content")
    <img class="banner" src="{{asset($service->title_image)}}" alt="" loading="lazy">
    <div class="container content corporate_file">
        <div class="row">
            ...
            <div class="row posts col-md-9">
                ...
                <div class="col-md-4">
                    <img src="{{asset($service->title_image)}}" alt="" loading="lazy">
                </div>
                @switch(app()->getLocale())
                    @case("tr")
                        <div class="services_post col-md-8">
                            ...
                            <a class="get_price_btn" target="_blank" href="https://api.whatsapp.com/send?phone=+905340167522&amp;text=Merhaba,%20size%20web%20sitenizden%20ula%C5%9F%C4%B1yorum.">{{__("service.take_price")}}</a>
                        </div>
                ...
                <div class="single_post_gallery gallerys">
                    @foreach($service->getGallery as $gallery)
                        <a href="{{asset($gallery->image)}}" target="_blank" class="picture">
                            <img src="{{asset($gallery->image)}}" alt="">
                        </a>
                    @endforeach
                </div>
                <div class="post_social_media" style="margin-top: 20px;">
                    ...
                    <a target="_blank" href="https://api.whatsapp.com/send?phone=+905340167522&amp;text=Merhaba,%20size%20web%20sitenizden%20ula%C5%9F%C4%B1yorum." class="wp"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
                    ...
                    <a target="_blank" href="https://www.instagram.com/carpe_diem_tour_transfer/" class="insta" style="background: #de2465;">                        <svg class="instagram_icon" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a target="_blank" href="https://www.tiktok.com/@carpe_diem_tour_transfer?lang=tr-TR" class="tt" style="background: black;"><img style="width: 20px; margin-bottom: 0 !important;" class="tiktok_icon_post" src="https://www.designbust.com/download/1840/png/tiktok_white_transparent512.png" alt=""></a>
                    <a target="_blank" href="https://www.youtube.com/channel/UCDmXuKG1v3dvmEYSgCUhHBw" class="yt" style="background: #FF0000;">                        <svg class="youtube_icon" xmlns="http://www.w3.org/2000/svg"
