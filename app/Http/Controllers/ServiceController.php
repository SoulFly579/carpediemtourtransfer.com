...
class ServiceController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if($request->hasFile('title_image')){
            ...
            $path = Storage::disk("public")->put("services/$fileName",$image);
            if($path == 1){
                $path = "storage/services/".$fileName;
            }else{
                return abort(500);
            }
    ...
    public function update($id, Request $request){
        ...
        if($request->hasFile('title_image')){
            if(Storage::exists(Str::replace("storage","",$service->title_image))){
                Storage::delete(Str::replace("storage","",$service->title_image));
            }
            $image = Image::make($request->file("title_image"))->encode("jpg",50);
            $fileName = Str::uuid().".jpg";
            $path = Storage::disk("public")->put("services/$fileName",$image);
    ...
    public function service_gallery_delete(Request $request)
    {
        ...
        return redirect("/admin/services")->with("success","Image deleted.");
    }
